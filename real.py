...
def get_bollinger_bands(close_dataframe, rate=sma_inp):
    global loop_num, bought, sold, sold2, bought2, sold_price2, good_above, good_below, hist_port_value, short_price2, buy_price2, buy_price, buy_money, short_price, is2, sold_price, bought_back_price, total_profit, bad_above, bad_below
